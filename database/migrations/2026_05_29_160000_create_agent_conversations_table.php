...
/**
 * Re-publica a migration de conversas do Laravel AI SDK (removida na Fase 1), agora necessária para o
 * recurso de conversa persistente do assistente de estatísticas (admin). Tabelas e conexão vêm da
 * config `ai.conversations.*`.
 */
