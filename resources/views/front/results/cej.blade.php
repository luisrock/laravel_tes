...
@section('sumulas_total_text')
    ...
    @endif
    <span class="tw-text-slate-600">em CEJ/JORNADAS para</span> <mark class="tw-bg-brand-100 tw-text-brand-800 tw-px-1 tw-rounded tw-font-semibold">{{ $keyword }}</mark>
@endsection

@section('sumulas_inner_table')
  @include('front.results.inners.cej_sum')
@endsection
