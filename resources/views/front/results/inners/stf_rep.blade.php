@foreach ($output['tese']['hits'] as $rep)
      <tr>
        <td>
          ...
          <span class="tes-clear tes-text-to-be-copied" style="display: none">TEMA: {{ $rep['trib_rep_tema'] }} TESE: {{ $rep['trib_rep_tese'] }} {{ $rep['trib_rep_titulo'] }}, {{ $rep['trib_rep_relator'] }}, aprovada em {{ $rep['trib_rep_data'] }}.</span>
